      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with our team for questions, support, or to learn more about our Innovation Lab facilities and
            programs.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      info@innovationlab.edu
                      <br />
                      support@innovationlab.edu
                    </p>
                  </div>
                </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.category} onValueChange={(value) => handleInputChange("category", value)}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="access">Lab Access</SelectItem>
                          <SelectItem value="equipment">Equipment Support</SelectItem>
